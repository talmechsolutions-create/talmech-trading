...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/manufacturing-intelligence/quality/material-test-certificate' },
};
...
export default function MaterialTestCertificatePage() {
  ...
  return (
    <TmisRecordView
      entity={record}
      primaryAction={{ label: 'Build EN24 RFQ', href: '/manufacturing-intelligence/rfq/en24-round-bar' }}
      secondaryAction={{ label: 'Open EN24 Round Bar', href: '/manufacturing-intelligence/products/en24-round-bar' }}
    />
  );
}
