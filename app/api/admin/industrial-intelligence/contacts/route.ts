...
import { createManualIndustrialContact } from '@/lib/industrial/managementService';
...
export async function POST(req: NextRequest) {
  ...
  try {
    const result = await createManualIndustrialContact(await req.json(), access.actor.username);
